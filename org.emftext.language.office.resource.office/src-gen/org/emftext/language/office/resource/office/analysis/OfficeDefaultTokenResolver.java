 ...
 */
public class OfficeDefaultTokenResolver implements org.emftext.language.office.resource.office.IOfficeTokenResolver {
	 ...
	 */
	public OfficeDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public OfficeDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.office.resource.office.IOfficeTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.office.resource.office.grammar.OfficeGrammarInformationProvider.INSTANCE.getKeywords()) {
