 ...
 */
public interface IOfficeOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().getResourcePostProcessorProviderOptionKey();
