 ...
 * 
 */
package org.emftext.language.office.resource.office.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class OfficeLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.emftext.language.office.resource.office.util.AbstractOfficeInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.emftext.language.office.resource.office.util.AbstractOfficeInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.emftext.language.office.resource.office.debug.OfficeDebuggableInterpreter<ResultType, ContextType> interpreter = new org.emftext.language.office.resource.office.debug.OfficeDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.emftext.language.office.resource.office.debug.OfficeDebuggerListener<ResultType, ContextType> debugListener = new org.emftext.language.office.resource.office.debug.OfficeDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.emftext.language.office.resource.office.debug.OfficeDebugProcess process = new org.emftext.language.office.resource.office.debug.OfficeDebugProcess(launch);
		launch.addDebugTarget(new org.emftext.language.office.resource.office.debug.OfficeDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.emftext.language.office.resource.office.launch.OfficeLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.emftext.language.office.resource.office.util.OfficeResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.emftext.language.office.resource.office.mopp.OfficePlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
