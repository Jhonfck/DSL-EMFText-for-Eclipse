 ...
 */
public class OfficeEnumerationTerminal extends org.emftext.language.office.resource.office.grammar.OfficeTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public OfficeEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.emftext.language.office.resource.office.grammar.OfficeCardinality cardinality, int mandatoryOccurrencesAfter) {
