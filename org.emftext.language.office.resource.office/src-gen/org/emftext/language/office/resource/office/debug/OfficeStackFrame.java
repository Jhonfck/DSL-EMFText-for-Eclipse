...
public class OfficeStackFrame extends org.emftext.language.office.resource.office.debug.OfficeDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.emftext.language.office.resource.office.debug.OfficeDebugTarget target;
	private String name;
	private int id;
	...
	public OfficeStackFrame(org.emftext.language.office.resource.office.debug.OfficeDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.emftext.language.office.resource.office.util.OfficeStringUtil.decode(data, ',');
	...
	private org.emftext.language.office.resource.office.debug.OfficeDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.emftext.language.office.resource.office.debug.OfficeStackFrame other = (org.emftext.language.office.resource.office.debug.OfficeStackFrame) obj;
		if (name == null) {
