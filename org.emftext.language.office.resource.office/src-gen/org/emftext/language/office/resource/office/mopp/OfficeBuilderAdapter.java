...
public class OfficeBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.emftext.language.office.resource.office.builder";
	
	private org.emftext.language.office.resource.office.IOfficeBuilder defaultBuilder = new org.emftext.language.office.resource.office.mopp.OfficeBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.emftext.language.office.resource.office.IOfficeBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.emftext.language.office.resource.office.mopp.OfficeResource customResource = (org.emftext.language.office.resource.office.mopp.OfficeResource) resourceSet.getResource(uri, true);
			new org.emftext.language.office.resource.office.mopp.OfficeMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.emftext.language.office.resource.office.IOfficeBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.emftext.language.office.resource.office.mopp.OfficeMarkerHelper().getMarkerID(org.emftext.language.office.resource.office.OfficeEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.emftext.language.office.resource.office.mopp.OfficeTaskItemBuilder taskItemBuilder = new org.emftext.language.office.resource.office.mopp.OfficeTaskItemBuilder();
		new org.emftext.language.office.resource.office.mopp.OfficeMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().getSyntaxName())) {
