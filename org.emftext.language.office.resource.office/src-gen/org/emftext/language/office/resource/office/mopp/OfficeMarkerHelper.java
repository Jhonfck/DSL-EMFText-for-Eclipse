 ...
 * contains
 * <code>org.emftext.language.office.resource.office.IOfficeTextDiagnostic</code>s
...
public class OfficeMarkerHelper {
	 ...
	 */
	public static final String MARKER_TYPE = org.emftext.language.office.resource.office.mopp.OfficePlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.office.resource.office.IOfficeCommand<Object>> commands = new java.util.ArrayList<org.emftext.language.office.resource.office.IOfficeCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.emftext.language.office.resource.office.IOfficeCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.emftext.language.office.resource.office.IOfficeCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.office.resource.office.IOfficeCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.emftext.language.office.resource.office.IOfficeCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.office.resource.office.IOfficeTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.office.resource.office.IOfficeTextDiagnostic diagnostic) {
		final org.emftext.language.office.resource.office.IOfficeProblem problem = diagnostic.getProblem();
		org.emftext.language.office.resource.office.OfficeEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.office.resource.office.IOfficeCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.office.resource.office.OfficeEProblemSeverity.ERROR) {
					...
					org.emftext.language.office.resource.office.IOfficeTextDiagnostic textDiagnostic = (org.emftext.language.office.resource.office.IOfficeTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.office.resource.office.mopp.OfficeResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.office.resource.office.mopp.OfficeResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.office.resource.office.IOfficeQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.office.resource.office.util.OfficeStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.office.resource.office.OfficeEProblemType nextType : org.emftext.language.office.resource.office.OfficeEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.office.resource.office.OfficeEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.office.resource.office.OfficeEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.emftext.language.office.resource.office.OfficeEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.emftext.language.office.resource.office.util.OfficeRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.emftext.language.office.resource.office.IOfficeCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.emftext.language.office.resource.office.mopp.OfficePlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
