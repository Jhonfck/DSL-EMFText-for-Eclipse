 ...
 */
public class OfficePlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.office.resource.office";
	/**
	...
	private static OfficePlugin plugin;
	...
	public static OfficePlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, OfficePlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, OfficePlugin.PLUGIN_ID, message);
		}
		final OfficePlugin pluginInstance = OfficePlugin.getDefault();
