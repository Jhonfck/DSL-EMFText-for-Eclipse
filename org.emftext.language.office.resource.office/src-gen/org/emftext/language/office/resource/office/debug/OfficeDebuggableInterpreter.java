 ...
 */
public class OfficeDebuggableInterpreter<ResultType, ContextType> extends org.emftext.language.office.resource.office.debug.AbstractOfficeDebuggable {
	
	/**
	 * The actual interpreter. Interpretation is delegated to this object.
	 */
	private org.emftext.language.office.resource.office.util.AbstractOfficeInterpreter<ResultType, ContextType> interpreterDelegate;
	
	/**
	 * To check whether we must stop the execution after step over/into/return, we use
	 * a closure
	 */
	private org.emftext.language.office.resource.office.IOfficeCommand<org.eclipse.emf.ecore.EObject> stopCondition;
	...
	public OfficeDebuggableInterpreter(org.emftext.language.office.resource.office.util.AbstractOfficeInterpreter<ResultType, ContextType> interpreterDelegate, int eventPort) {
		this.eventPort = eventPort;
		this.interpreterDelegate = interpreterDelegate;
		this.interpreterDelegate.addListener(new org.emftext.language.office.resource.office.IOfficeInterpreterListener() {
	...
	public String[] getStack() {
		...
		for (org.eclipse.emf.ecore.EObject parent : parents) {
			String serializedStackElement = org.emftext.language.office.resource.office.util.OfficeStringUtil.encode(',', new String[] {parent.eClass().getName(), Integer.toString(stackFrameID), parent.eResource().getURI().toString(), Integer.toString(getLine(parent)), Integer.toString(getCharStart(parent)), Integer.toString(getCharEnd(parent))});
	...
	public org.emftext.language.office.resource.office.util.AbstractOfficeInterpreter<ResultType, ContextType> getInterpreterDelegate() {
		return interpreterDelegate;
	}
	
	private int getLine(org.eclipse.emf.ecore.EObject element) {
		int line = -1;
		org.emftext.language.office.resource.office.IOfficeLocationMap locationMap = getLocationMap(element);
		if (locationMap != null) {
	...
	private org.emftext.language.office.resource.office.IOfficeLocationMap getLocationMap(org.eclipse.emf.ecore.EObject element) {
	...
	private void evaluateStep(org.eclipse.emf.ecore.EObject element) {
		...
		org.emftext.language.office.resource.office.IOfficeCommand<org.eclipse.emf.ecore.EObject> stopCheck = stopCondition;
		if (stopCheck != null && stopCheck.execute(element)) {
			stopCondition = null;
			// suspending after step...
			setSuspend(true);
			sendEvent(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.SUSPENDED, true);
			return;
		}
		waitIfSuspended();
	}
	...
	public void stepOver() {
		...
		final int currentLevel = org.emftext.language.office.resource.office.util.OfficeEObjectUtil.getDepth(current);
		stopCondition = new org.emftext.language.office.resource.office.IOfficeCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
				...
				int depth = org.emftext.language.office.resource.office.util.OfficeEObjectUtil.getDepth(element);
	...
	public void stepReturn() {
		...
		final int parentLevel = org.emftext.language.office.resource.office.util.OfficeEObjectUtil.getDepth(current) - 1;
		stopCondition = new org.emftext.language.office.resource.office.IOfficeCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
