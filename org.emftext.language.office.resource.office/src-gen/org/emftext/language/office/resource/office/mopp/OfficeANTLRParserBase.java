...
public abstract class OfficeANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements org.emftext.language.office.resource.office.IOfficeTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<org.emftext.language.office.resource.office.IOfficeCommand<org.emftext.language.office.resource.office.IOfficeTextResource>> postParseCommands;
	...
	public OfficeANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input) {
		super(input);
	}
	
	public OfficeANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input, org.antlr.runtime3_4_0.RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, org.emftext.language.office.resource.office.grammar.OfficeSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof org.emftext.language.office.resource.office.grammar.OfficePlaceholder;
		isElementToStore |= syntaxElement instanceof org.emftext.language.office.resource.office.grammar.OfficeKeyword;
		isElementToStore |= syntaxElement instanceof org.emftext.language.office.resource.office.grammar.OfficeEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof org.emftext.language.office.resource.office.grammar.OfficeBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new org.emftext.language.office.resource.office.mopp.OfficeLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(org.emftext.language.office.resource.office.IOfficeOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(org.emftext.language.office.resource.office.IOfficeOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.emftext.language.office.resource.office.mopp.OfficeDummyEObject dummy) {
		...
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = org.emftext.language.office.resource.office.util.OfficeMapUtil.castToEMap(value);
	...
	protected org.emftext.language.office.resource.office.mopp.OfficeTokenResolveResult getFreshTokenResolveResult() {
	...
	protected org.emftext.language.office.resource.office.mopp.OfficeReferenceResolverSwitch getReferenceResolverSwitch() {
		org.emftext.language.office.resource.office.mopp.OfficeReferenceResolverSwitch resolverSwitch = (org.emftext.language.office.resource.office.mopp.OfficeReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
