...
public class OfficeLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.emftext.language.office.resource.office.debug.lineBreakpoint.marker";
	
	public OfficeLineBreakpoint() {
		super();
	}
	
	public OfficeLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.emftext.language.office.resource.office.debug.OfficeDebugTarget target) {
		try {
	...
	public void remove(org.emftext.language.office.resource.office.debug.OfficeDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
