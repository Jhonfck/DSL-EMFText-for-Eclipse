 ...
 * code).
 */
public class OfficeDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.emftext.language.office.resource.office.debug.AbstractOfficeDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.emftext.language.office.resource.office.util.OfficePair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.emftext.language.office.resource.office.util.OfficePair<String, Object>>();
	...
	public OfficeDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.emftext.language.office.resource.office.debug.OfficeDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.emftext.language.office.resource.office.util.OfficeStringUtil.encode('#', stack);
				org.emftext.language.office.resource.office.debug.OfficeDebugMessage message = new org.emftext.language.office.resource.office.debug.OfficeDebugMessage(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.emftext.language.office.resource.office.debug.OfficeDebugMessage message = new org.emftext.language.office.resource.office.debug.OfficeDebugMessage(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.GET_VARIABLES)) {
				...
				org.emftext.language.office.resource.office.debug.OfficeDebugMessage message = new org.emftext.language.office.resource.office.debug.OfficeDebugMessage(org.emftext.language.office.resource.office.debug.EOfficeDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.emftext.language.office.resource.office.util.OfficeStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.emftext.language.office.resource.office.util.OfficePair<String, Object> pair = new org.emftext.language.office.resource.office.util.OfficePair<String, Object>(name, value);
	...
	public org.emftext.language.office.resource.office.debug.AbstractOfficeDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.emftext.language.office.resource.office.debug.AbstractOfficeDebuggable debuggable) {
