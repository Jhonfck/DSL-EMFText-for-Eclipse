...
public class OfficeDebugValue extends org.emftext.language.office.resource.office.debug.OfficeDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public OfficeDebugValue(org.emftext.language.office.resource.office.debug.OfficeDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
