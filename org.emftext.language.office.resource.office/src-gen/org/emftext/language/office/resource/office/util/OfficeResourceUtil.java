...
public class OfficeResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.emftext.language.office.resource.office.util.OfficeInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.emftext.language.office.resource.office.util.OfficeInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.emftext.language.office.resource.office.mopp.OfficeResource getResource(java.io.File file) {
	...
	public static org.emftext.language.office.resource.office.mopp.OfficeResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.emftext.language.office.resource.office.mopp.OfficeResource) resource;
	}
	 ...
	 */
	public static org.emftext.language.office.OfficeModel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.emftext.language.office.OfficeModel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.emftext.language.office.OfficeModel) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.emftext.language.office.OfficeModel getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.emftext.language.office.resource.office.IOfficeTextResource resource = (org.emftext.language.office.resource.office.IOfficeTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.emftext.language.office.resource.office.IOfficeTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.emftext.language.office.resource.office.IOfficeTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
