...
public class OfficeBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.office.resource.office.IOfficeBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.office.resource.office.IOfficeBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.office.resource.office.ui.IOfficeBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.office.resource.office.IOfficeBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public OfficeBracketSet(org.emftext.language.office.resource.office.ui.OfficeEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.office.resource.office.IOfficeBracketPair>();
	 ...
	 */
	public org.emftext.language.office.resource.office.IOfficeBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.office.resource.office.IOfficeBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.office.resource.office.IOfficeBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.office.resource.office.IOfficeBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.office.resource.office.ui.OfficePreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.office.resource.office.IOfficeBracketPair remove(String opening, String closing) {
		for (org.emftext.language.office.resource.office.IOfficeBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.office.resource.office.IOfficeBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.office.resource.office.ui.OfficePositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.office.resource.office.ui.OfficePositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
