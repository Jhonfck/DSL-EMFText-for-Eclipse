 ...
 */
public class OfficeCompletionProposal implements java.lang.Comparable<OfficeCompletionProposal> {
	 ...
	 */
	private org.emftext.language.office.resource.office.mopp.OfficeExpectedTerminal expectedTerminal;
	...
	public OfficeCompletionProposal(org.emftext.language.office.resource.office.mopp.OfficeExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public org.emftext.language.office.resource.office.mopp.OfficeExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof OfficeCompletionProposal) {
			OfficeCompletionProposal other = (OfficeCompletionProposal) object;
	...
	public int compareTo(OfficeCompletionProposal object) {
		if (object instanceof OfficeCompletionProposal) {
			OfficeCompletionProposal other = (OfficeCompletionProposal) object;
