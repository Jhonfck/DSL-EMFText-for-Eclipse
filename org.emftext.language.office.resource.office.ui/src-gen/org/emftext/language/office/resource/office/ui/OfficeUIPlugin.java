 ...
 */
public class OfficeUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.office.resource.office.ui";
	public static final String EDITOR_ID = "org.emftext.language.office.resource.office.ui.OfficeEditor";
	...
	private static OfficeUIPlugin plugin;
	
	public OfficeUIPlugin() {
		super();
	}
	...
	public static OfficeUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, OfficeUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, OfficeUIPlugin.PLUGIN_ID, message);
		}
		final OfficeUIPlugin pluginInstance = OfficeUIPlugin.getDefault();
