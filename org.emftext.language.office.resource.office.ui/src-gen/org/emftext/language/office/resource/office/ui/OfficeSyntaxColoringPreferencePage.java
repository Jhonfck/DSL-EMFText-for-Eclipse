 ...
 */
public class OfficeSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public OfficeSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.office.resource.office.mopp.OfficeMetaInformation metaInformation = new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.office.resource.office.ui.OfficeSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.office.resource.office.ui.OfficePixelConverter pixelConverter = new org.emftext.language.office.resource.office.ui.OfficePixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.office.resource.office.ui.OfficeEditor) {
			org.emftext.language.office.resource.office.ui.OfficeEditor emfTextEditor = (org.emftext.language.office.resource.office.ui.OfficeEditor) editor;
