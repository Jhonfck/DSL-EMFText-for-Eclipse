 ...
 * olInput</code>.
 */
public class OfficeDocBrowserInformationControlInput {
	
	private final OfficeDocBrowserInformationControlInput fPrevious;
	private OfficeDocBrowserInformationControlInput fNext;
	 ...
	 */
	public OfficeDocBrowserInformationControlInput(OfficeDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public OfficeDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public OfficeDocBrowserInformationControlInput getNext() {
		return fNext;
	}
