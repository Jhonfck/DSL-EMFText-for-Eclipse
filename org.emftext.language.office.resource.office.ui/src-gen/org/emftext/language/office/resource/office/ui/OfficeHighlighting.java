 ...
 */
public class OfficeHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.emftext.language.office.resource.office.ui.OfficePositionHelper positionHelper = new org.emftext.language.office.resource.office.ui.OfficePositionHelper();
	...
	private org.emftext.language.office.resource.office.ui.OfficeTokenScanner scanner;
	...
	private org.emftext.language.office.resource.office.ui.OfficeEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.language.office.resource.office.ui.OfficeOccurrence occurrence;
	private org.emftext.language.office.resource.office.ui.OfficeBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.office.resource.office.IOfficeBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public OfficeHighlighting(org.emftext.language.office.resource.office.IOfficeTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.office.resource.office.ui.OfficeColorManager colorManager, org.emftext.language.office.resource.office.ui.OfficeEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.office.resource.office.ui.OfficeUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.office.resource.office.ui.OfficeTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.office.resource.office.ui.OfficeOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.office.resource.office.ui.OfficeBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.office.resource.office.ui.OfficePreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.office.resource.office.ui.OfficePreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.office.resource.office.ui.OfficeEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.office.resource.office.ui.OfficePositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.office.resource.office.ui.OfficePositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.office.resource.office.ui.OfficePositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.office.resource.office.ui.OfficeEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
