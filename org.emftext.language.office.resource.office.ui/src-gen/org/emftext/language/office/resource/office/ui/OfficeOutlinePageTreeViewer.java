...
public class OfficeOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public OfficeOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.language.office.resource.office.util.OfficeStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.office.resource.office.mopp.OfficePlugin.logError("Exception while refreshing outline view", e);
		}
	}
