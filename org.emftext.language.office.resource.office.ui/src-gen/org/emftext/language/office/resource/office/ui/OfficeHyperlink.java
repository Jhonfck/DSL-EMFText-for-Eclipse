 ...
 */
public class OfficeHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public OfficeHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.office.resource.office.mopp.OfficePlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
