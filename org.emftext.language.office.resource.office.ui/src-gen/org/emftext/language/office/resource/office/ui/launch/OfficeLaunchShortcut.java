 ...
 */
public class OfficeLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.emftext.language.office.resource.office.launch.OfficeLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.emftext.language.office.resource.office.mopp.OfficePlugin.logError("Exception while launching selection", e);
		}
	}
