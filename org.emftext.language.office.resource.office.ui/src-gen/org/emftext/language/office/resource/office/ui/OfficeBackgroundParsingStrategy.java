 ...
 */
public class OfficeBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.office.resource.office.IOfficeTextResource resource, final org.emftext.language.office.resource.office.ui.OfficeEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.office.resource.office.IOfficeTextResource resource, final org.emftext.language.office.resource.office.ui.OfficeEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.office.resource.office.IOfficeTextResource resource, final org.emftext.language.office.resource.office.ui.OfficeEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.office.resource.office.mopp.OfficeResource) {
							org.emftext.language.office.resource.office.mopp.OfficeResource concreteResource = (org.emftext.language.office.resource.office.mopp.OfficeResource) resource;
