 ...
 */
public class OfficeNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.office.resource.office.ui");
							...
							String natureID = org.emftext.language.office.resource.office.mopp.OfficeNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.office.resource.office.mopp.OfficeNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.office.resource.office.mopp.OfficeMetaInformation info = new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.office.resource.office.ui.OfficeUIPlugin.getDefault().getBundle();
