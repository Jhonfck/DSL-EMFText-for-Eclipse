 ...
 */
public class OfficeCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.office.resource.office.IOfficeBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.office.resource.office.ui.OfficeEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.office.resource.office.ui.OfficeEditor) {
				org.emftext.language.office.resource.office.ui.OfficeEditor editor = (org.emftext.language.office.resource.office.ui.OfficeEditor) workbenchPart;
	...
	protected org.emftext.language.office.resource.office.ui.OfficeEditor editor;
	 ...
	 */
	public OfficeCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.office.resource.office.ui.OfficeEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.office.resource.office.ui.OfficeEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.office.resource.office.ui.OfficeUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.office.resource.office.IOfficeTextResource textResource = (org.emftext.language.office.resource.office.IOfficeTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
