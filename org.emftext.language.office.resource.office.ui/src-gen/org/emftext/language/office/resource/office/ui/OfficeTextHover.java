 ...
 */
public class OfficeTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.office.resource.office.IOfficeHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.office.resource.office.ui.OfficeBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.office.resource.office.ui.OfficeBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput infoInput = (org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.office.resource.office.ui.OfficeHyperlink hyperlink = new org.emftext.language.office.resource.office.ui.OfficeHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.office.resource.office.ui.OfficeBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.office.resource.office.ui.OfficeBrowserInformationControl iControl = new org.emftext.language.office.resource.office.ui.OfficeBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput) {
							org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput input = (org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.office.resource.office.ui.OfficeBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.office.resource.office.ui.OfficeBrowserInformationControl iControl = new org.emftext.language.office.resource.office.ui.OfficeBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public OfficeTextHover(org.emftext.language.office.resource.office.IOfficeResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.office.resource.office.ui.OfficeUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.office.resource.office.ui.OfficeHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.office.resource.office.ui.OfficeHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.office.resource.office.ui.OfficeHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.office.resource.office.ui.OfficeTextHover.getStyleSheet());
			org.emftext.language.office.resource.office.ui.OfficeHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.office.resource.office.ui.OfficeHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.office.resource.office.ui.OfficeUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.office.resource.office.util.OfficeStreamUtil.getContent(styleSheetURL.openStream());
