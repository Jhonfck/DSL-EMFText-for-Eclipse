 ...
 */
public class OfficeNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public OfficeNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new office file");
