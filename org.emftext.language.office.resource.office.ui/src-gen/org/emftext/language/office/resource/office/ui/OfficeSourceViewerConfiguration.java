 ...
 */
public class OfficeSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.emftext.language.office.resource.office.ui.OfficeQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public OfficeSourceViewerConfiguration(org.emftext.language.office.resource.office.IOfficeResourceProvider resourceProvider, org.emftext.language.office.resource.office.ui.IOfficeAnnotationModelProvider annotationModelProvider, org.emftext.language.office.resource.office.ui.IOfficeBracketHandlerProvider bracketHandlerProvider, org.emftext.language.office.resource.office.ui.OfficeColorManager colorManager) {
		super(org.emftext.language.office.resource.office.ui.OfficeUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.office.resource.office.ui.OfficeCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.emftext.language.office.resource.office.ui.OfficeTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.office.resource.office.ui.OfficeTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.office.resource.office.ui.OfficeHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.emftext.language.office.resource.office.ui.OfficeQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.emftext.language.office.resource.office.ui.OfficeIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
