 ...
 * 
 */
package org.emftext.language.office.resource.office.ui.debug;

@SuppressWarnings("restriction")
public class OfficeAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().getSyntaxName())) {
					return new org.emftext.language.office.resource.office.ui.debug.OfficeLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.emftext.language.office.resource.office.debug.OfficeDebugVariable) {
			final org.emftext.language.office.resource.office.debug.OfficeDebugVariable variable = (org.emftext.language.office.resource.office.debug.OfficeDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.emftext.language.office.resource.office.debug.OfficeDebugVariable) {
			final org.emftext.language.office.resource.office.debug.OfficeDebugVariable variable = (org.emftext.language.office.resource.office.debug.OfficeDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.emftext.language.office.resource.office.debug.OfficeDebugValue castedValue = (org.emftext.language.office.resource.office.debug.OfficeDebugValue) value;
