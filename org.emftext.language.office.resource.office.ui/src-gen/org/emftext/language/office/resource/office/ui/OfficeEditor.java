...
/**
 * A text editor for 'office' models.
 * <p>
 * This editor has id
 * <code>org.emftext.language.office.resource.office.ui.OfficeEditor</code>
 * The editor's context menu has id
 * <code>org.emftext.language.office.resource.office.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.emftext.language.office.resource.office.EditorRuler</code>.
 * </p>
 */
public class OfficeEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.office.resource.office.IOfficeResourceProvider, org.emftext.language.office.resource.office.ui.IOfficeBracketHandlerProvider, org.emftext.language.office.resource.office.ui.IOfficeAnnotationModelProvider {
	
	private org.emftext.language.office.resource.office.ui.OfficeHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.office.resource.office.ui.OfficeCodeFoldingManager codeFoldingManager;
	private org.emftext.language.office.resource.office.ui.OfficeBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.office.resource.office.ui.OfficeBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.office.resource.office.IOfficeBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.office.resource.office.IOfficeBackgroundParsingListener>();
	private org.emftext.language.office.resource.office.ui.OfficeColorManager colorManager = new org.emftext.language.office.resource.office.ui.OfficeColorManager();
	private org.emftext.language.office.resource.office.ui.OfficeOutlinePage outlinePage;
	...
	private org.emftext.language.office.resource.office.ui.OfficePropertySheetPage propertySheetPage;
	...
	private org.emftext.language.office.resource.office.ui.IOfficeBracketHandler bracketHandler;
	...
	public OfficeEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.office.resource.office.ui.OfficeSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), OfficeEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.office.resource.office.IOfficeTextResource currentResource = getResource();
				...
				org.emftext.language.office.resource.office.ui.OfficeUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.office.resource.office.EditorContext");
		setRulerContextMenuId("org.emftext.language.office.resource.office.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.office.resource.office.ui.OfficeHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.office.resource.office.ui.OfficeCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.office.resource.office.mopp.OfficeNature.activate(inputFile.getProject());
		...
		org.emftext.language.office.resource.office.IOfficeTextResource loadedResource = (org.emftext.language.office.resource.office.IOfficeTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.office.resource.office.IOfficeTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.office.resource.office.IOfficeTextResource) {
					setResource((org.emftext.language.office.resource.office.IOfficeTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.office.resource.office.ui.OfficeUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the OfficeEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.office.resource.office.ui.OfficeUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.office.resource.office.IOfficeTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.office.resource.office.ui.OfficeOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.office.resource.office.ui.OfficePropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.office.resource.office.IOfficeTextResource textResource = (org.emftext.language.office.resource.office.IOfficeTextResource) element.eResource();
			...
			org.emftext.language.office.resource.office.IOfficeTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.office.resource.office.IOfficeTextToken token = lexer.getNextToken();
			...
			org.emftext.language.office.resource.office.ui.OfficeUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!OfficeEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.office.resource.office.IOfficeBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.office.resource.office.IOfficeBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.office.resource.office.ui.IOfficeBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.office.resource.office.ui.IOfficeBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.emftext.language.office.resource.office.IOfficeTextResource)) {
					return false;
				}
				org.emftext.language.office.resource.office.IOfficeTextResource textResource = (org.emftext.language.office.resource.office.IOfficeTextResource) resource;
				org.emftext.language.office.resource.office.IOfficeLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
