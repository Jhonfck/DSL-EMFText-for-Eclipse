...
public class OfficeOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			org.emftext.language.office.resource.office.IOfficeNameProvider nameProvider = new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().createNameProvider();
