 ...
 * @since 3.2
 */
public class OfficeBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput fInput;
	 ...
	 */
	public OfficeBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public OfficeBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public OfficeBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput) input;
		...
		org.emftext.language.office.resource.office.ui.OfficeHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.office.resource.office.ui.OfficeHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.office.resource.office.ui.OfficeDocBrowserInformationControlInput getInput() {
		return fInput;
	}
