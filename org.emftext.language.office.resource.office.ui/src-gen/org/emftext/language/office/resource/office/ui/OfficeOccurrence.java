 ...
 */
public class OfficeOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.language.office.resource.office.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.language.office.resource.office.ui.occurences.declaration";
	...
	private org.emftext.language.office.resource.office.ui.OfficeTokenScanner tokenScanner;
	 ...
	 */
	public OfficeOccurrence(org.emftext.language.office.resource.office.IOfficeTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.language.office.resource.office.ui.OfficeTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.language.office.resource.office.mopp.OfficeMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.emftext.language.office.resource.office.ui.OfficeBracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.emftext.language.office.resource.office.ui.OfficePositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if (elementsAtDefinition.contains(occEO) || definitionElement.equals(occEO)) {
						addAnnotation(document, org.emftext.language.office.resource.office.ui.OfficePositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.emftext.language.office.resource.office.ui.OfficePositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.emftext.language.office.resource.office.ui.OfficePositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.emftext.language.office.resource.office.ui.OfficeOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.language.office.resource.office.ui.OfficeOccurrence.DECLARATION_ANNOTATION_ID);
	}
