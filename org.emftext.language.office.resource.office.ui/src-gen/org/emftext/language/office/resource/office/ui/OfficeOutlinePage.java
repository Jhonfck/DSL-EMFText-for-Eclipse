 ...
 */
public class OfficeOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.emftext.language.office.resource.office.ui.outlinecontext";
	...
	private org.emftext.language.office.resource.office.ui.OfficeOutlinePageTreeViewer treeViewer;
	private org.eclipse.core.runtime.ListenerList selectionChangedListeners = new org.eclipse.core.runtime.ListenerList();
	
	public OfficeOutlinePage(org.emftext.language.office.resource.office.IOfficeResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new org.emftext.language.office.resource.office.ui.OfficeOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new org.emftext.language.office.resource.office.ui.OfficeOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.emftext.language.office.resource.office.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new org.emftext.language.office.resource.office.ui.OfficeOutlinePageActionProvider().getActions(treeViewer);
