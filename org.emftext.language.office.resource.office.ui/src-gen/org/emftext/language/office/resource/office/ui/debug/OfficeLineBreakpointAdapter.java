...
public class OfficeLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.emftext.language.office.resource.office.mopp.OfficePlugin.DEBUG_MODEL_ID);
			...
			org.emftext.language.office.resource.office.debug.OfficeLineBreakpoint lineBreakpoint = new org.emftext.language.office.resource.office.debug.OfficeLineBreakpoint(resource, lineNumber + 1);
