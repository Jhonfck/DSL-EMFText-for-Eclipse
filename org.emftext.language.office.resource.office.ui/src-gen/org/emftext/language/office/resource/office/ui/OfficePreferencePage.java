 ...
 */
public class OfficePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.office.resource.office.ui.OfficeUIPlugin.getDefault().getPreferenceStore());
		setDescription("Office Text Editor Preferences");
	}
